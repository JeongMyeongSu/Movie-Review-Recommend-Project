...
| 박윤지 | Python<br />Django<br />Vue.js<br />HTML / CSS<br />JavaScript<br />Bootstrap<br />c9 | Project management<br />ERD Construction<br />Recommendation algorithm<br />UX/UI design<br />API management<br />Website Distribution |
